...
class OdnoklassnikiSDK
{
    ...
    private static $app_id = "1146255872";
    private static $app_public_key = "CBALHDFFEBABABABA";
    private static $app_secret_key = "72C8ACABABE600141660AD43";
    private static $redirect_url = "http://aliebay.ru";
    ...
    private static $access_token = 'tkn1IlcqnvVHUmYvJ2HpomVMyaQdf7MrNTPZoTuxJNFxuYK3wSj55Rug6ZzX0KjVqQDFO0';
